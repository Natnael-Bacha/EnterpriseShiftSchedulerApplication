  ...
  Future<void> _createAdmin() async {
    ...
    try {
      ...
      if (userCredential.user != null) {
        ...
        print("Adding admin to mongo");
        bool success = await adminRepo.addAdmin(newAdmin);

        if (success) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text("Admin saved to database")),
          );
        } else {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(const SnackBar(content: Text("Failed to save admin")));
        }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(e.message ?? "Admin creation failed")),
      );
    } finally {
